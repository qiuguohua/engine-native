/*
**
** Copyright 2007, The openharmony Open Source Project
**
...
#include "audio/openharmony/audio.h"
#include "audio/openharmony/audio_utils/include/audio_utils/primitives.h"

#include "audio/openharmony/AudioMixerOps.h"
#include "audio/openharmony/AudioMixer.h"
...
static inline audio_format_t selectMixerInFormat(audio_format_t inputFormat) {
...
void AudioMixer::track__nop(track_t *t , int32_t *out ,
                            size_t outFrameCount , int32_t *temp , int32_t *aux ) {
}
...
void AudioMixer::process__genericNoResampling(state_t *state, int64_t pts) {
    ...
    while (e0) {
        ...
        do {
            ...
            out = reinterpret_cast<int32_t *>((uint8_t *)out + BLOCKSIZE * t1.mMixerChannelCount * audio_bytes_per_sample(t1.mMixerFormat));
            numFrames += BLOCKSIZE;
