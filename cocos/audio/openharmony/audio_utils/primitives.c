/*
 * Copyright (C) 2011 The openharmony Open Source Project
 *
...
#include "audio/openharmony/audio_utils/private/private.h"
#include "audio/openharmony/cutils/bitops.h" /* for popcount() */
